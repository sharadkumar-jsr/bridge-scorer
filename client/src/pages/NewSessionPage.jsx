                ...
                {[
                  ...
                  <button key={opt.value} type="button"
                    ...
                    <div className={`font-semibold text-sm
                      ${movementType === opt.value ? 'text-gold-300' : 'text-cream-100'}`}>
                      {opt.label}
                    </div>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer mt-3">
                    ...
                    <div>
                      ...
                      <p className="text-cream-400 text-xs">
                        Enable if you have an odd number of pairs
                      </p>
                    </div>
                  </label>
                </>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="number" min="1" max="20"
                      ...
                      className="input-felt" placeholder="e.g. 4" />
                  </div>
                  <div>
                    ...
                    <input type="number" min="1" max="30"
                      ...
                      className="input-felt" placeholder="e.g. 7"
